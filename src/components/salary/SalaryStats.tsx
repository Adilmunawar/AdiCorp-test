          ...
          {loading ? <Loader2 className="h-6 w-6 animate-spin text-green-600" /> : (
            <>
              <div className="flex items-center">
                ...
                <span className="text-2xl font-bold">{formatCurrencySync(stats.totalBudgetSalary)}</span>
              </div>
          ...
          {loading ? <Loader2 className="h-6 w-6 animate-spin text-blue-600" /> : (
            <>
              <div className="flex items-center">
                ...
                <span className="text-2xl font-bold">{formatCurrencySync(stats.totalCalculatedSalary)}</span>
              </div>
          ...
          {loading ? <Loader2 className="h-6 w-6 animate-spin text-purple-600" /> : (
            <>
              <div className="flex items-center">
                ...
                <span className="text-2xl font-bold">{formatCurrencySync(stats.averageDailyRate)}</span>
              </div>
